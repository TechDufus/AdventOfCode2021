# This solution code belongs to DevBlackOps
# https://github.com/devblackops/advent-of-code/blob/main/2021/day4/part1.ps1

#Things I learned from this solution:
#  - Creating a 2 dimensional array of objects using [int[,]] and [bool[,]]
#      - This allows you to reference a specific value in the array like [$column, $row]
#      - I have literally never seen this before, and it blows my mind..
#  - Using a constructor in a powershell class.
#      - I've only ever created properties or void methods in a powershell class, never a constructor for the class. This is very cool.
